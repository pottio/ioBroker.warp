...
class WarpApiDefinitions {
  ...
  defineEvse() {
    ...
    evse.add("evse/reset_dc_fault_current_state", "The state of the DC fault current protection module. If a DC fault occurs, charging is no longer possible until the protection module has been reset. Before resetting, it is imperative that the reason for the fault is rectified!", [
      import_models.Param.butt("reset_dc_fault_current_state", "normal").onlyWarp2().withDescription("Resets the DC residual current protection module. Before resetting, it is imperative that the reason for the fault is rectified!").build()
    ]);
  ...
  defineMeter() {
    ...
    meter.add("meter/phases", "Connected and active phases", [
      import_models.Param.list("phases_active", "bool").withDescription("Active phases: L1 | L2 | L3").build(),
      import_models.Param.list("phases_connected", "bool").withDescription("Connected phases: L1 | L2 | L3").build()
    ]);
